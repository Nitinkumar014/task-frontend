...
const Board = () => {
  ...
  const fetchUser = async () => {
    ...
    try {
      ...
      const res = await fetch("https://task-backend-2-4t93.onrender.com/api/auth/profile", {
        headers: {
  ...
  const fetchTasks = async () => {
    try {
      ...
      const res = await fetch(
        `https://task-backend-2-4t93.onrender.com/api/tasks/${selectedBoard._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`
          }
...
const fetchBoards = async () => {
  try {
    ...
    const res = await fetch("https://task-backend-2-4t93.onrender.com/api/boards", {
      headers: {
        "Authorization": `Bearer ${token}`
      }
    });
...
const deleteBoard = async (id, e) => {
  ...
  try {
    ...
    await fetch(`https://task-backend-2-4t93.onrender.com/api/boards/${id}`, {
      method: "DELETE",
      headers: {
        "Authorization": `Bearer ${token}`
      }
...
const handleCreateTask = async () => {
  ...
  try {
    ...
    const res = await fetch("https://task-backend-2-4t93.onrender.com/api/tasks", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`
...
const handleDrop = async (targetColumn) => {
  ...
  try {
    ...
    await fetch(`https://task-backend-2-4t93.onrender.com/api/tasks/${draggedTask._id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`
...
const deleteTask = async (column, id) => {
  ...
  try {
    ...
    await fetch(`https://task-backend-2-4t93.onrender.com/api/tasks/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`
      }
